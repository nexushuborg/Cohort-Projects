...
describe('Product Image Service', () => {
  ...
  describe('uploadImage', () => {
    ...
    it('should throw 404 for nonexistent product', async () => { productRepository.findById.mockResolvedValue(null); await expect(service.uploadImage('nonexistent', mockFile)).rejects.toThrow('Product not found'); });
  ...
  describe('getImagesByProductId', () => {
    ...
    it('should throw 404 for nonexistent product', async () => { productRepository.findById.mockResolvedValue(null); await expect(service.getImagesByProductId('nonexistent')).rejects.toThrow('Product not found'); });
  });
  ...
  describe('setPrimaryImage', () => {
    ...
    it('should throw 404 for nonexistent product', async () => { productRepository.findById.mockResolvedValue(null); await expect(service.setPrimaryImage('nonexistent', mockImage.id)).rejects.toThrow('Product not found'); });
  ...
  describe('deleteImage', () => {
    ...
    it('should throw 404 for nonexistent product', async () => { productRepository.findById.mockResolvedValue(null); await expect(service.deleteImage('nonexistent', mockImage.id)).rejects.toThrow('Product not found'); });
